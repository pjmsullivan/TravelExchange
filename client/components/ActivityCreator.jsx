...
const ActivityCreator = (props) => {
    return (
        <div>
            ...
            <form method="POST" action='/homepage/activity'>
                <label>What would you like to do? </label><br></br>
                    <input name="activityName" type="text" placeholder="addActivity" /><br></br><br></br>
                    <input name="activityCost" type="text" placeholder="Price" /><br></br><br></br>
                    <input name="itineraryId" type="text" placeholder="ID" /><br></br>
                <br></br>
...
//     })
// }      
>>>>>>> 050dba10d0ac15357f4be265aa21d679360bdacc
